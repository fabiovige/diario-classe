...
class GradeLevelSeeder extends Seeder
{
    public function run(): void
    {
        $gradeLevels = [
            ...
            ['name' => '1º Ano', 'type' => 'elementary', 'order' => 7, 'min_age_months' => 72],
            ['name' => '2º Ano', 'type' => 'elementary', 'order' => 8, 'min_age_months' => 84],
            ['name' => '3º Ano', 'type' => 'elementary', 'order' => 9, 'min_age_months' => 96],
            ['name' => '4º Ano', 'type' => 'elementary', 'order' => 10, 'min_age_months' => 108],
            ['name' => '5º Ano', 'type' => 'elementary', 'order' => 11, 'min_age_months' => 120],
            ['name' => '6º Ano', 'type' => 'elementary', 'order' => 12, 'min_age_months' => 132],
            ['name' => '7º Ano', 'type' => 'elementary', 'order' => 13, 'min_age_months' => 144],
            ['name' => '8º Ano', 'type' => 'elementary', 'order' => 14, 'min_age_months' => 156],
            ['name' => '9º Ano', 'type' => 'elementary', 'order' => 15, 'min_age_months' => 168],
